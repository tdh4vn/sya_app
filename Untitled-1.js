...
function CalcAQI(form) {
    ...
    if (b == 'Out of Range') {
        let myWindowOofR = window.open('', '', 'width=450,height=75,left=450,menubar=no,top=200');
        ...
        let myWindowSO1 = window.open('', '', 'width=450,height=75,left=450,menubar=no,top=200');
        ...
        let myWindowSO24 = window.open('', '', 'width=450,height=75,left=450,menubar=no,top=200');
